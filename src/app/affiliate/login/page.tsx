...
import { Lock, User, ArrowRight, Sun, Moon, Home, Award, TrendingUp, Users, DollarSign, Shield, CheckCircle } from "lucide-react";
...
function AffiliateLoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Affiliate login:', { identifier, password });
      setLoading(false);
    } catch (error) {
